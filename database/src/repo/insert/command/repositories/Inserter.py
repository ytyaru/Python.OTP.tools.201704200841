...
#    def __init__(self, db, client, user, repo):
        ...
        self.__userRepo = self.__db.repos[self.__username]
...
#                self.__InsertLanguages(r['Id'], self.__authData.Name, j['name'])
                ...
                print(r['Id'])
                self.__userRepo['Licenses'].insert(self.__CreateRecordRepositoryLicenses(r['Id'], self.__db.license['Licenses'].find_one(Key=j['license']['key'])['Id']))
